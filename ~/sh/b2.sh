...
#LXQt Desktop
#pacman -Sy --needed lxqt openbox obconf-qt pcmanfm-qt lxqt-sudo lightdm lightdm-gtk-greeter sddm breeze-icons qterminal kwrite partitionmanager networkmanager-qt qbittorrent pavucontrol-qt quodlibet kdenlive k3b xarchiver galculator polkit-qt5 --noc

#Plasma Desktop
#pacman -Sy --needed plasma lightdm lightdm-gtk-greeter sddm breeze-icons kwrite partitionmanager qbittorrent pavucontrol-qt quodlibet print-manager sweeper dolphin kdenlive k3b ark konsole gwenview okular kcalc  --noc

echo 'Xfce Desktop'
pacman -Sy --needed xfce4 xfce4-goodies lightdm lightdm-gtk-greeter sddm galculator gparted transmission-gtk pavucontrol xfburn asunder libburn libisofs libisoburn quodlibet pitivi xarchiver arc-gtk-theme arc-icon-theme gtk-engine-murrine adapta-gtk-theme polkit-gnome gnome-disk-utility gufw gnome-packagekit --noc

#Mate Desktop
#pacman -Sy --needed mate mate-extra mate-applet-dock lightdm lightdm-gtk-greeter lightdm lightdm-gtk-greeter sddm adapta-gtk-theme arc-gtk-theme arc-icon-theme gtk-engine-murrine gparted transmission-gtk brasero asunder quodlibet pitivi gnome-disk-utility gufw mate-polkit gnome-packagekit --noc

#Cinnamon Desktop
#pacman -Sy --needed cinnamon cinnamon-translations gnome-terminal adwaita-icon-theme adapta-gtk-theme arc-gtk-theme arc-icon-theme gtk-engine-murrine gnome-keyring lightdm lightdm-gtk-greeter sddm nemo nemo-share xed file-roller nemo-fileroller tmux tldr gparted transmission-gtk brasero asunder quodlibet pitivi gnome-disk-utility gufw polkit-gnome gnome-packagekit evince viewnior --noc
#
#
echo 'F. enable services'
read -p "use which dm.service sddm or lightdm? :" dm
...
#
#
#2. Automatically clean the package cache using pacman hooks: --noc
#
...
#Target = *
#[Action]
#Description = Cleaning pacman cache... --noc
